  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        {
          title: item
            ? `${item.title} — Habitat for Humanity Barry County`
            : "News — Habitat Barry County",
        },
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="mx-auto w-full max-w-4xl px-4 pb-12">
            <AnimatedSection>
              <Link
                to="/"
                className="mb-4 inline-flex items-center gap-1.5 text-sm text-primary-foreground/70 transition-colors hover:text-primary-foreground"
              >
              ...
              <h1 className="mt-2 font-heading text-3xl font-bold text-primary-foreground sm:text-4xl lg:text-5xl">
                {item.title}
              </h1>
            </AnimatedSection>
          </div>
            ...
            <div className="mt-16 grid gap-4 border-t border-border pt-8 sm:grid-cols-2">
              {prevArticle && (
                ...
                >
                  ...
                  <h3 className="mt-1 font-heading font-semibold text-foreground group-hover:text-primary">
                    {prevArticle.title}
                  </h3>
                </Link>
              )}
