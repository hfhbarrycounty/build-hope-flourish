  ...
  return (
    <>
      <section className="relative h-[40vh] min-h-[300px] overflow-hidden">
        <img src={whatWeDoHero} alt="Volunteers building roof trusses at the construction site" className="h-full w-full object-cover" style={{ <img src={whatWeDoHero} alt="Volunteers building roof trusses at the construction site" className="h-full w-full object-cover" style={{ objectPosition: "center 35%" }} width={1920} height={1080} /> }} width={1920} height={1080} />
