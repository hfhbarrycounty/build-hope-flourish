  ...
  return (
    <>
      <section className="relative h-[40vh] min-h-[300px] overflow-hidden">
        <img src={volunteerFraming} alt="Volunteers framing a house at the build site" className="h-full w-full object-cover" style={{ objectPosition: "center 35%" }} width={1920} height={1080} /> src={volunteerFraming} alt="Volunteers framing a house at the build site" className="h-full w-full object-cover" style={{ objectPosition: "center 35%" }} width={1920} height={1080} /> />
