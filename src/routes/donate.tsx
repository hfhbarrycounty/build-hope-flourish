  ...
  return (
    <>
      <section className="relative h-[40vh] min-h-[300px] overflow-hidden">
        <img src={donateBanner} alt="Volunteers building a home together at golden hour" className="h-full w-full <img src={donateBanner} alt="Volunteers building a home together at golden hour" className="h-full w-full object-cover" style={{ objectPosition: "center 35%" }} width={1920} height={1080} /> />
